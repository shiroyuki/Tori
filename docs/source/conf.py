# -*- coding: utf-8 -*-
#
# Tori documentation build configuration file, created by
...
#extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.coverage', 'sphinx.ext.pngmath']
...
texinfo_documents = [
  ('index', 'Tori', u'Tori Documentation',
   u'Juti Noppornpitak', 'Tori', 'One line description of project.',
   'Miscellaneous'),
]
...
MOCK_MODULES = [
    ...
    # 'imagination.helper.data.Transformer',
    # 'imagination.helper.data.Interception',
    # 'imagination.helper.data.ParameterPackage',
    # 'imagination.locator',
